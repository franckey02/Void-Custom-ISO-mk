# Void Live Maker Mod by JavierC
- NOTA:SOLO FUNCIONA EN VOID
- En la carpeta includedir añades los directorios,configuraciones temas etc que quieres que tenga tu voidlinux
- En la carpeta grub modificas el menu de arranque y demas etc...
- make.sh crea el iso personalizado (lo podes editar para cambiar el nombre de la iso y los paquetes que tendra)

https://github.com/franckey02/Void-Custom-ISO-mk/releases/download/void-iso-custom-25-02/void-custom-iso.7z

-- lo que sigue despues de este texto en español es el Readme.MD  normal
